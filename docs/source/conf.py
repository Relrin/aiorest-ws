...
# -*- coding: utf-8 -*-
#
# aiorest-ws documentation build configuration file, created by
...
htmlhelp_basename = 'aiorest-wsdoc'
...
latex_documents = [
  (master_doc, 'aiorest-ws.tex', 'aiorest-ws Documentation',
   'Valeryi Savich', 'manual'),
]
...
man_pages = [
    (master_doc, 'aiorest-ws', 'aiorest-ws Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'aiorest-ws', 'aiorest-ws Documentation',
   author, 'aiorest-ws', 'One line description of project.',
   'Miscellaneous'),
]
